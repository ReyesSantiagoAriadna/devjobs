...
<div class="flex flex-col mt-10">
          ...
          <tbody class="bg-white">
            ...
            <tr>
              ...
              <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 font-medium">
                    <a href="{{route('vacantes.edit', ['vacante' => $vacante])}}" class="text-teal-600 hover:text-teal-900 mr-5">Editar</a>

                    <eliminar-vacante vacante-id="{{$vacante->id}}"></eliminar-vacante>

                    <a href="{{route('vacantes.show',['vacante' => $vacante])}}" class="text-blue-600 hover:text-blue-900">Ver</a>
              </td>
            </tr>
            @endforeach
  ...
  {{$vacantes->links()}}
@else
  <p class="text-center mt-10 text-gray-700">No tienes vacantes</p>
@endif
